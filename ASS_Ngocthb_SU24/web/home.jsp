<%-- 
    Document   : admin
    Created on : May 19, 2024, 8:34:06 PM
    Author     : Lenovo
--%>
            ...
            <div class="container-flex">
                <div class="hero-content">
                    <h1
                        ...
                        <span class="brand-span">Sound - Light and Music</span> Education.
                    </h1>
                    <p
                        style="
                        transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1)
                        ...
                        >
                        Music is the common language of mankind. Music exists deep in each person's heart. 
                        We has the mission of awakening and developing a love of music, 
                        share and bring joy to others through the 
                        distribution of music equipment, audio equipment, and music.
                    </p>
                    <div
                        style="
                        transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1)
                        ...
                        >
                        <a href="carts.jsp" class="button w-button">Place an Booking</a>
                    </div>
                    <div
                        style="
                        transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1)
                        ...
                        <div class="review-text">
                            <span class="brand-span">4.8 out of 5</span> based on 2000+
                            reviews
                        </div>
                    </div>
                </div>
                <div class="hero-image-wrap">
                    <img
                        src="View/Img/banner.png"
                        alt="Piano banner"

                        sizes="(max-width: 612px) 94vw, (max-width: 991px) 576px, 47vw"
                        style="
                        opacity: 1;
                        transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1)
                        rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg);
            ...
            <div class="container">
                ...
                <div
                    ...
                    <%
                        ...
                        List<Course> listCsr = dao.getTopCourse();
                        if (listCsr != null) {
                            if (listCsr.size() > 0) {
                    %>
                ...
                <div
                    ...
                    class="button-wrapper"
                    >
                    <a href="search-csr-result.jsp" class="button w-button">See Full Course</a>
                </div>
            </div>
        </div>
        <%
